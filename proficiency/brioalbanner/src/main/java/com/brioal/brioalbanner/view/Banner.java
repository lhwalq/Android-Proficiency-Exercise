...
public class Banner extends RelativeLayout {
    ...
    private TextView tvDesc, tvUserName, tvTime;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        View itemView = LayoutInflater.from(getContext()).inflate(R.layout.content_bg, null, false);
        LayoutParams itemViewParams = new LayoutParams(RelativeLayout.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        itemViewParams.addRule(ALIGN_PARENT_BOTTOM);
        tvDesc = (TextView) itemView.findViewById(R.id.tv_desc);
        tvUserName = (TextView) itemView.findViewById(R.id.tv_user_name);
        tvTime = (TextView) itemView.findViewById(R.id.tv_time);
        addView(itemView, itemViewParams);
        ...
        bottonParams.setMargins(0, 0, 0, 32);
//        mBottonLayout.setBackgroundColor(Color.argb(mAlpha, 0, 0, 0));
    ...
    public void setList(List<BannerEntity> list, String desc, String userName, String time) {
        mList = list;
        mViews = new ArrayList<>();
        mBottonLayout.setDotSum(list.size());
        mBottonLayout.setVisibility(1 == mList.size() ? GONE : VISIBLE);
        tvDesc.setText(desc);
        ...
        for (int i = 0; i < mList.size(); i++) {
            ...
            Glide.with(getContext()).load(entity.getmImageUrl()).into(iv);
//            ((TextView) itemView.findViewById(R.id.tv_desc)).setText(entity.getmDesc());
//            ((TextView) itemView.findViewById(R.id.tv_user_name)).setText(entity.getmUserName());
//            ((TextView) itemView.findViewById(R.id.tv_time)).setText(entity.getmTime());
            final int finalI = i;
