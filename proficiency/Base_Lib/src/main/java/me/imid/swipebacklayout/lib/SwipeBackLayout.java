...
public class SwipeBackLayout extends FrameLayout {
    ...
    private SwipeProcess swipeProcess;
        ...
        public void onViewPositionChanged(View changedView, int left, int top, int dx, int dy) {
            ...
            if (mScrollPercent >= 1) {
                if (!mActivity.isFinishing()) {
                	...
                	if(null!=swipeProcess) {
                		swipeProcess.beforeFinishActivity(mActivity);
                	}
    ...
    public SwipeProcess getSwipeProcess() {
		return swipeProcess;
	}

	public void setSwipeProcess(SwipeProcess swipeProcess) {
		this.swipeProcess = swipeProcess;
	}
     ...
     * @ author:linjunying
     */
	public interface SwipeProcess {
		
		// 在finishActivity前
		void beforeFinishActivity(Activity act);
	}
}
